<?php
    ...
    if ($_POST) {
        ...
        $query = "SELECT * FROM Buyer WHERE Username = '$username';";
...
<body>
    <header>
        ...
        <div class="banner-container">
            ...
            <div class="account-container">
                <a href="http://localhost/apna-Project/admin_login.php"><p><i class="fa-solid fa-right-to-bracket" style="padding: 0;"></i> Admin Login</p></a>
            </div>
        </div>
    </header>
    <?php if ($accountExists == false) { ?>
    ...
    <div class="log-container">
        <div class="log-sub-container" >
            ...
            <form class="log-sub-2-container-2" method="POST" action="login.php">
            ...
            <hr>
            <div class="log-sub-2-container-4">
                <div class="log-button-container">
                    <a href="http://localhost/Apna-Project/signup.php"><button>Register</button></a>
                </div>
            </div>
        </div>
    </div>
